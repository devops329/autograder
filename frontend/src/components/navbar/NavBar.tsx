        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          {props.user ? (
            <>
              {props.isAdmin && (
                <>
                  <InputGroup data-bs-theme="light" style={{ width: '12rem', margin: '1rem 1rem 1rem 0' }}>
                    ...
                    />
                    {props.impersonating ? (
                      <Button variant="success" className="m-0" onClick={() => navBarPresenter.stopImpersonating()}>
                        <svg
                      ...
                      <>
                        <Button variant="primary" className="m-0" onClick={() => navBarPresenter.impersonate(impersonateSearchString!)}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
              ...
              <Button variant="outline-danger" onClick={() => navBarPresenter.logOut()}>
                Logout
              </Button>
            </>
          ) : (
            <Button onClick={() => navBarPresenter.logIn()}>Login</Button>
          )}
        </Navbar.Collapse>
      </Container>
    </Navbar>
